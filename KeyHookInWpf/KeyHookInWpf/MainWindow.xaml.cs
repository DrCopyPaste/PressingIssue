...
namespace KeyHookInWpf
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            mahook.AddOrUpdateOnReleaseHotkey("Pause", new Services.Contracts.HotkeyAction() { Action = () => logger.Info("this was on release!") });
            ...
            */
            ...
            mahook.AddOrUpdateQuickCastHotkey("F12", new Services.Contracts.HotkeyAction() { Action = () => logger.Info("this was with quickcast!") });
